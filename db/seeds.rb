...
unless Brewery.find_by(name: "Catfish Tail Brewing Company")
  puts "seeded"
  ...
  User.create(username: "Red Ranger", email: "notdoug@email.com", password: "hello1", dob: '1989-01-01', location: "NYC", image: "http://pre05.deviantart.net/0662/th/pre/i/2013/289/0/3/red_ranger_by_thuddleston-d6qq8jy.jpg")
  User.create(username: "guest", email: "guest@guest.com", password: "hello1", dob: '1989-01-01', location: "NYC")
end

User.create(username: "Homer Simpson", email:"homer@springfieldnuclear.com", password: "hello1", location: "Springfield", image: "http://img00.deviantart.net/485d/i/2011/242/b/6/homer_simpson_by_marinav92-d48c6y1.jpg")
25.times do
  brewery = Brewery.create(name: Faker::Company.name, location: Faker::Address.city)
  (rand(10)).times do
    brewery.beers.create(name: Faker::Commerce.product_name, style: Faker::Company.buzzword, abv: rand(10), ibu: rand(100))
  end
end


100.times do
  User.create(username: Faker::Internet.user_name, email: Faker::Internet.email, password: "hello1", dob: '1989-01-01', location: "NYC")
end
